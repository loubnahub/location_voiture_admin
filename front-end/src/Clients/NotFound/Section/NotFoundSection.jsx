...
const NotFoundSection = () => { // Corrected component name from NotFounSection to NotFoundSection
  ...
  return (
    <div className="tw-bg-[#1B1B1B] tw-min-h-screen tw-text-white">
      ...
      <div
        className="tw-relative tw-h-[50vh] sm:tw-h-[60vh] md:tw-h-96 lg:tw-h-[550px] tw-flex tw-items-center tw-justify-start tw-bg-cover tw-bg-center tw-bg-fixed" // Added tw-bg-fixed
