...
const TestiominalsSection = () => {
  // Background image for the section
  const heroBackgroundImage = '/images/Cars/Testiominals.png'; // Ensure this path is correct in your public folder
    ...
    <div className="tw-bg-[#1B1B1B] tw-min-h-screen tw-text-white">
      ...
      >
        ...
        <div className="tw-relative tw-z-10 tw-text-left tw-px-8 md:tw-px-16 tw-max-w-4xl">
          ...
          What  <span className="tw-text-amber-400">Clients Say</span>
          </h1>
        </div>
      </div>
...
export default TestiominalsSection;