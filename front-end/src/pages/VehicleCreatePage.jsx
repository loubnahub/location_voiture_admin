      ...
      <Form onSubmit={handleSave}>
        <Row>
          <Col lg={8}>
            ...
            <Card className="shadow-sm mb-4">
              <Card.Header><LuPalette className="me-2" />Details </Card.Header>
              <Card.Body>
                ...
                <Row><Col md={6}><Form.Group className="mb-3"><Form.Label>Mileage <span className="text-danger">*</span></Form.Label><InputGroup><Form.Control type="number" name="mileage" value={formData.mileage} onChange={handleInputChange} required min="0" /><InputGroup.Text>km</InputGroup.Text></InputGroup></Form.Group></Col>
                {/* <Col md={6}><Form.Group className="mb-3"><Form.Label>Status <span className="text-danger">*</span></Form.Label><Form.Select name="status" value={formData.status} onChange={handleInputChange} required>{statusOptions.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}</Form.Select></Form.Group></Col> */}</Row>
